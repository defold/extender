...
* Compile and link an OS X executable

    x86_64-apple-darwin11-clang -arch x86_64 -target x86_64-apple-darwin11 -isysroot /opt/MacOSX.sdk/ hw.c

# OLD Compiling and linking OS X on Linux
