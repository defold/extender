...
public class XCConfigParserTest {
    ...
    private static Stream<Arguments> parsingData() {
        ...
        return Stream.of(
            Arguments.of("AppLovinSDK", new File("test-data/xcconfigs/AppLovinSDK.xcconfig"), "AppLovinSDK", Map.of(
            ...
            Arguments.of("AppMetricaLog", new File("test-data/xcconfigs/AppMetricaLog.xcconfig"), "AppMetricaLog", Map.of(
                "DEFINES_MODULE", "YES",
                "GCC_PREPROCESSOR_DEFINITIONS", "COCOAPODS=1",
            ...
            Arguments.of("DivKit", new File("test-data/xcconfigs/DivKit.xcconfig"), "DivKit", Map.of(
                "GCC_PREPROCESSOR_DEFINITIONS", "COCOAPODS=1",
            ...
            Arguments.of("KSCrash", new File("test-data/xcconfigs/KSCrash.xcconfig"), "KSCrash", Map.of(
                "GCC_PREPROCESSOR_DEFINITIONS", "COCOAPODS=1",
            ...
            Arguments.of("MintegralAdSDK", new File("test-data/xcconfigs/MintegralAdSDK.xcconfig"), "MintegralAdSDK", Map.of(
            ...
            Arguments.of("Sentry", new File("test-data/xcconfigs/Sentry.xcconfig"), "Sentry", Map.of(
            ...
            Arguments.of("VGSLFundamentals", new File("test-data/xcconfigs/VGSLFundamentals.xcconfig"), "VGSLFundamentals", Map.of(
                "GCC_PREPROCESSOR_DEFINITIONS", "COCOAPODS=1",
