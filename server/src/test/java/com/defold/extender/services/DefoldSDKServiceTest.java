...
public class DefoldSDKServiceTest {
    ...
    public void t() throws IOException, URISyntaxException, ExtenderException {
        DefoldSdkService defoldSdkService = new DefoldSdkService("/tmp/defoldsdk", 3, mock(CounterService.class), mock(MeterRegistry.class));
    ...
    public void onlyStoreTheNewest() throws IOException, URISyntaxException, ExtenderException {
        int cacheSize = 3;
        DefoldSdkService defoldSdkService = new DefoldSdkService("/tmp/defoldsdk", cacheSize, mock(CounterService.class), mock(MeterRegistry.class));
