...
export ANDROID_SDK_BUILD_TOOLS_PATH_33=${ANDROID_HOME}/build-tools/${ANDROID_BUILD_TOOLS_VERSION}
export ANDROID_SDK_BUILD_TOOLS_PATH=${ANDROID_HOME}/build-tools/${ANDROID_BUILD_TOOLS_VERSION}
export ANDROID_LIBRARYJAR_33=${ANDROID_HOME}/platforms/android-${ANDROID_SDK_VERSION}/android.jar
export ANDROID_LIBRARYJAR=${ANDROID_HOME}/platforms/android-${ANDROID_SDK_VERSION}/android.jar
export ANDROID_PROGUARD=_
export PATH=${PATH}:${ANDROID_HOME}/platform-tools:${ANDROID_SDK_BUILD_TOOLS_PATH}
